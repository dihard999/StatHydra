...
2. [Player](#player)  
   ...
   2.6 [Get player leaders by year and specific rank](#league_leaders_{year}/category/rank{rank})
4. [Team](#team)  
...
6. [Playoff](#playoff)  
   ...
   5.5 [Get playoff result for the current season and specific game](#league_playoff_series_result_now/game/{game_id})  
...
```
<a name="league_leaders_{year}/category/rank{rank}"></a>
### 2.6 Get player leaders by year and specific rank
- **Endpoint:** `/league_leaders_{year}/category/rank{rank}`
- **Method:** GET
...
```
<a name="league_playoff_series_result_now/game/{game_id}"></a>
### 5.5 Get playoff result for the current season and specific game
- **Endpoint:** `/league_playoff_series_result_now/game/{game_id}/`
- **Method:** GET
